...
js = urllib2.urlopen("http://texassports.com/roster.aspx?path=baseball")
team = "baseball"
...
for line in js:
	if "roster_dgrd_full_name" in line:
		...
		y = line.find("<i>")
		z = line.find("</a>")
		firstname = line[x+len(team)+2:y].strip()
		lastname = line[y+7:z]
		i = 0
		while 1:
		...
		fileName = lastname.replace(" ","_").lower() + "_" + firstname.replace(" ","_").lower() + "_" + player_number.strip() + ".jpg"
